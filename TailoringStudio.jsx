    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 70 }}>
        ...
        <div onClick={() => setActivePage("home")} style={{ cursor: "pointer" }}>
          ...
          <div style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.6rem", letterSpacing: "0.3em", textTransform: "uppercase", color: COLORS.charcoalLight, marginTop: 2 }}>Est. 2009 · Vijayawada</div>
        </div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center", position: "relative", zIndex: 1 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.9, marginBottom: 20 }}>
            Born into a family of skilled artisans in Vijayawada, Meena Devi discovered her passion for tailoring at age 14. Over 15 years, she has woven her mastery of traditional Telugu craftsmanship with contemporary fashion sensibility.
          </p>
          <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.9, marginBottom: 36 }}>
            Every bride who walks out of Tailoring Studio carries with her not just a garment, but a piece of art — stitched with love, precision, and an intimate understanding of what makes a woman feel extraordinary.
          </p>
...
function TestimonialsSection() {
  ...
  const testimonials = [
    { name: "Priya Lakshmi", role: "Bride, Oct 2024", text: "Meena Devi created the most beautiful bridal blouse I've ever seen. Every detail was perfect, from the zardosi embroidery to the exact fit. I felt like royalty on my wedding day. Highly recommend to every bride!", rating: 5, location: "Vijayawada" },
    ...
    { name: "Radha Venkat", role: "Mother of Bride", text: "Both my daughter's wedding blouses were made here. The bridal work, the finishing — everything was exquisite. Meena ji has a true gift for understanding what a bride needs.", rating: 5, location: "Vijayawada" },
  ];
      ...
      <div style={{ background: COLORS.charcoal, color: "white", padding: "24px 32px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.6rem", fontWeight: 500, color: "white" }}>Tailoring Studio Dashboard</h1>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
...
function FAQSection() {
  ...
  const faqs = [
    ...
    { q: "Do you offer home visit for measurements?", a: "Yes! For bridal and premium orders above ₹2,000, we offer free home visits in Vijayawada. For other areas, there's a small travel charge." },
    ...
    { q: "Do you deliver outside Vijayawada?", a: "Yes! We ship across Andhra Pradesh and Telangana via courier. For other states, courier charges apply. Delivery takes 3–5 additional days." },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 48, alignItems: "start" }}>
          ...
          <div>
            <div style={{ background: COLORS.charcoal, color: "white", padding: "40px 32px", marginBottom: 20 }}>
              ...
              {[
                { icon: "map", text: "Door No. 45, MG Road, Labbipet,\nVijayawada, Andhra Pradesh 520010" },
          ...
          <div>
            ...
            <div style={{ marginTop: 20, height: 240, background: `linear-gradient(135deg, ${COLORS.blush} 0%, ${COLORS.ivoryDark} 100%)`, display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid ${COLORS.ivoryDark}`, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
                ...
                <div style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: COLORS.charcoal, marginTop: 10 }}>Tailoring Studio · Vijayawada</div>
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.85rem", color: COLORS.charcoalLight, marginTop: 4 }}>MG Road, Labbipet</div>
                <button style={{ marginTop: 12, background: COLORS.roseGold, color: "white", border: "none", cursor: "pointer", padding: "8px 20px", fontFamily: "'Raleway', sans-serif", fontSize: "0.7rem", fontWeight: 600, letterSpacing: "0.1em" }}
                  onClick={() => window.open("https://maps.google.com/?q=Labbipet+Vijayawada", "_blank")}>
                  Open in Maps
                </button>
              </div>
            </div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 48, marginBottom: 48 }}>
          <div>
            ...
            <div style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.6rem", letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(255,255,255,0.3)", marginBottom: 20 }}>Est. 2009 · Vijayawada, AP</div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div style={{ fontFamily: "'Raleway', sans-serif", fontSize: "0.7rem", color: "rgba(255,255,255,0.3)", letterSpacing: "0.05em" }}>
            © 2026 Tailoring Studio · Vijayawada · All Rights Reserved
          </div>
